...
const onFinishLogin = async (values, rememberMe) => {
  try {
    const response = await axios.post("http://localhost:3030/panel/login", {
...
const onFinishRegister = async (values) => {
  try {
    const response = await axios.post("http://localhost:3030/panel/register", {
      name: values.name,
...
const onFinishResetPassword = async (values) => {
  try {
    ...
    axios.post("http://localhost:3030/panel/forgot-password-mail", formData, {
      headers: {
